...
import com.infinity.infoway.rkuniversity.rku_old_app.Pojo.ConfarancePubPojo;
...
public class ConferencePubApproveReject extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_act.setText("Publication in conference");
...
//        if (status.compareToIgnoreCase("Pending")==0)
        ...
        String url = URLS.Get_publication_conference_list + "&user_id=" + mySharedPreferecesRKUOLD.getUserID() + "&emp_id=" + mySharedPreferecesRKUOLD.getEmpID() + "&RowsPerPage=" + URLS.RowsPerPage + "&PageNumber=" + "1" + "&status=" + status + "&id=" + id + "";
                        ...
                        if (confarancePubPojo.getData() != null) {
                            if (confarancePubPojo.getData().get(0) != null) {
                                if (confarancePubPojo.getData().size() > 0) {
                                    ...
                                    edttitleproceeding.setText(confarancePubPojo.getData().get(0).getIpc_conference_title() + "");
                                    ...
                                    ivfile.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View v) {
                                            ...
                                            if (!marshMallowPermission.checkPermissionForExternalStorage()) {
                                                ...
                                                if (confarancePubPojo.getData().get(0).getIpc_file_upload() != null &&
                                                        !confarancePubPojo.getData().get(0).getIpc_file_upload().isEmpty()) {
    ...
    private class DownloadFileFromURL extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... f_url) {
            ...
            try {
                ...
                conection.connect();
//                File dir = new File(Environment.getExternalStorageDirectory().getAbsolutePath() + "/Rku/" + "/ConferencePub/");
//                dir.mkdirs();
//
//
...
//                // this will be useful so that you can show a tipical 0-100% progress bar
                ...
                File folder = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS) + "/" + FileAndFolderInfo.FOLDER_NAME + "/ConPubApproval/");
                folder.mkdirs();

                String actualFileName = FileAndFolderInfo.getCustomeFileName(mySharedPreferecesRKUOLD.getEmpCode(), "ConPubApproval",
...
//                OutputStream output = new FileOutputStream("sdcard/Rku/" + "/ConferencePub/" + nameoffile);
...
//
//            File file11 = new File(Environment.getExternalStorageDirectory().getAbsolutePath(), "Rku/" + "/ConferencePub/" + nameoffile);
...
////
            ...
            File file11 = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "/" + FileAndFolderInfo.FOLDER_NAME + "/ConPubApproval/" + actualFileName);
...
//        if (approve.compareToIgnoreCase("approve")==0)
        if (approve.compareToIgnoreCase(IntentConstants.APPROVED_STATUS_FOR_APPROVAL) == 0) {
            url = URLS.Get_publication_conference_Approved_or_Reject + "&id=" + ID + "&remarks=" + reason + "&user_id=" + mySharedPreferecesRKUOLD.getUserID() + "&ip=" + "" + "&approve_reject=" + "1" + "";

        } else {
            url = URLS.Get_publication_conference_Approved_or_Reject + "&id=" + ID + "&remarks=" + reason + "&user_id=" + mySharedPreferecesRKUOLD.getUserID() + "&ip=" + "" + "&approve_reject=" + "2" + "";
        ...
        tvapprove.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (ID != null && !ID.contentEquals("")) {
                    showDialog(ConferencePubApproveReject.this, IntentConstants.APPROVED_STATUS_FOR_APPROVAL, ID);
                }
            ...
            public void onClick(View v) {
                DialogUtils.showDialog4YNo(ConferencePubApproveReject.this, "", "Are You Sure To Reject ?", new DialogUtils.DailogCallBackOkButtonClick() {
                    ...
                    public void onDialogOkButtonClicked() {
                        showDialog(ConferencePubApproveReject.this, IntentConstants.REJECT_STATUS_FOR_APPROVAL, ID);
