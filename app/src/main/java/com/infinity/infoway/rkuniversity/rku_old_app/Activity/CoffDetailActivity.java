...
import com.infinity.infoway.rkuniversity.rku_old_app.Pojo.CoffDetailPojo;
...
public class CoffDetailActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void ApproveLeave(String approval_ID)
    {
        ...
        String URLs = URLS.compensatory_leave_approve + "&id=" + approval_ID + "" + "&ip=" + "1" + "&user_id=" + mySharedPreferecesRKUOLD.getUserID() + "&ex_req_emp_id=" + req_emp_id + "";
