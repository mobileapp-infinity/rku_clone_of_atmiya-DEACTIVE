...
//        DialogUtils.showProgressDialog(MissPunchUpdateActivity.this, "");
    ...
    private void RejectMissPunch(String reason, AlertDialog show)
    {
        ...
        String url = URLS.Employee_miss_punch_request_reject + "&id=" + ID + "&user_id=" + mySharedPreferecesRKUOLD.getUserID() + "&ip=" + "1" + "&empr_reject_reason=" + reason + "";
        url = url.replace(" ", "%20");
...
//                            startActivity(intent);
    ...
    private void ApproveMissPunch()
    {
        ...
        DialogUtils.showProgressDialog(MissPunchApprovedActivity.this, "");
        String url = URLS.Employee_miss_punch_request_approved + "&id=" + ID + "&user_id=" + mySharedPreferecesRKUOLD.getUserID() + "&ip=" + "1" + "";
        url = url.replace(" ", "%20");
        System.out.println("Employee_miss_punch_request_approved URL " + url + "");
        StringRequest request = new StringRequest(Request.Method.GET, url, new Response.Listener<String>()
        {
