...
import com.infinity.infoway.rkuniversity.rku_old_app.Adapter.AttReportAdapter;
import com.infinity.infoway.rkuniversity.rku_old_app.Adapter.SummeryAttAdapter;
...
import com.infinity.infoway.rkuniversity.rku_old_app.Pojo.AttReportDetailPojo;
import com.infinity.infoway.rkuniversity.rku_old_app.Pojo.AttfReportSummryPojo;
...
public class AttendanceReportActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void AttendanceReportApi(String month, String year) {
        ...
        String url = URLS.Get_employee_attendance_report_detail + "&month=" + month + "&year=" + year + "&emp_id=" + mySharedPreferecesRKUOLD.getEmpID() + "&user_id=" + mySharedPreferecesRKUOLD.getUserID() + "";
    ...
    private void SummeryDisplayApi(final String month, final String year) {
        ...
        DialogUtils.showProgressDialog(AttendanceReportActivity.this, "");
        String url = URLS.Get_employee_attendance_report_summary + "&month=" + month + "&year=" + year + "&emp_id=" + mySharedPreferecesRKUOLD.getEmpID() + "&user_id=" + mySharedPreferecesRKUOLD.getUserID() + "";
