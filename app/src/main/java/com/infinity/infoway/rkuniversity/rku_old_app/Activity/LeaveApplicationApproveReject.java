...
import com.infinity.infoway.rkuniversity.rku_old_app.Adapter.LeaveTypePopupAdapter;
...
//                DialogUtils.hideProgressDialog();
    ...
    private void ApproveLeave(String ID_leave, final AlertDialog show) {
        ...
        String url = URLS.employee_leave_application_approval + "&id=" + ID + "&ela_leave_type=" + ID_leave + "&user_id=" + mySharedPreferecesRKUOLD.getUserID() + "&ip=" + "1" + "";
        url = url.replace(" ", "%20");
...
//                response = "{\"Data\":" + response + "}";
    ...
    {
        DialogUtils.showProgressDialog(LeaveApplicationApproveReject.this, "");
        String url = URLS.employee_leave_application_reject + "&id=" + ID + "&ela_leave_type=" + Leave_Type_ID + "&user_id=" + mySharedPreferecesRKUOLD.getUserID() + "&ip=" + "1" + "&reason=" + reason + "";
        url = url.replace(" ", "%20");
