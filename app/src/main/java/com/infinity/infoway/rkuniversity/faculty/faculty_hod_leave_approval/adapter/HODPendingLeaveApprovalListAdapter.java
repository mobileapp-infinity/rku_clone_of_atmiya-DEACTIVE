...
public class HODPendingLeaveApprovalListAdapter extends RecyclerView.Adapter<HODPendingLeaveApprovalListAdapter.MyViewHolder> {
    ...
    public HODPendingLeaveApprovalListAdapter(Context context,
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = layoutInflater.inflate(R.layout.hod_leave_approval_list_item, parent, false);
...
//        }
//
//        if (!CommonUtil.checkIsEmptyOrNullCommon(hodStudentLeaveApproveApplicationAllPojo.getCourseNameApp())) {
//            holder.tvCourse.setText(hodStudentLeaveApproveApplicationAllPojo.getCourseNameApp() + "");
//        }
//
//        if (!CommonUtil.checkIsEmptyOrNullCommon(hodStudentLeaveApproveApplicationAllPojo.getSemNameApp())) {
//            holder.tvSem.setText(hodStudentLeaveApproveApplicationAllPojo.getSemNameApp() + "");
//        }
//
//        if (!CommonUtil.checkIsEmptyOrNullCommon(hodStudentLeaveApproveApplicationAllPojo.getStudDivApp())) {
//            holder.tvDiv.setText(hodStudentLeaveApproveApplicationAllPojo.getStudDivApp() + "");
//        }
//
//        if (!CommonUtil.checkIsEmptyOrNullCommon(hodStudentLeaveApproveApplicationAllPojo.getLeaveDate())) {
//            holder.tvDate.setText("Date : " + hodStudentLeaveApproveApplicationAllPojo.getLeaveDate() + "");
//        }
//
//        if (!CommonUtil.checkIsEmptyOrNullCommon(hodStudentLeaveApproveApplicationAllPojo.getLeactureNo())) {
//            holder.tvLectureNo.setText(hodStudentLeaveApproveApplicationAllPojo.getLeactureNo() + "");
//        }
//
//        if (!CommonUtil.checkIsEmptyOrNullCommon(hodStudentLeaveApproveApplicationAllPojo.getAppStatus())) {
//            holder.tvStatus.setText(hodStudentLeaveApproveApplicationAllPojo.getAppStatusText() + "");
//        }
//
//        if (!CommonUtil.checkIsEmptyOrNullCommon(hodStudentLeaveApproveApplicationAllPojo.getStudRemarks())) {
//            holder.tvRemarks.setText(hodStudentLeaveApproveApplicationAllPojo.getStudRemarks() + "");
//        }
//
//        if (!CommonUtil.checkIsEmptyOrNullCommon(hodStudentLeaveApproveApplicationAllPojo.getViewFile()) &&
//                hodStudentLeaveApproveApplicationAllPojo.getViewFile().length() > 7) {
//            holder.imgViewDoc.setVisibility(View.VISIBLE);
//        } else {
//            holder.imgViewDoc.setVisibility(View.GONE);
//        }
//
//        holder.imgViewDoc.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                String fileUrl = hodStudentLeaveApproveApplicationAllPojo.getViewFile().trim();
//                String fileExtension = fileUrl.substring(fileUrl.lastIndexOf("."));
...
//            @Override
//            public void onClick(View v) {
//                boolean show = toggleLayout(!hodStudentLeaveApproveApplicationAllPojo.isExpanded(), holder.ivViewMoreBtn, holder.llExpandableLayout);
//                hodStudentLeaveApproveApplicationAllPojo.setExpanded(show);
//            }
//        });
//
//        holder.rgroupApproveReject.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
//            @Override
//            public void onCheckedChanged(RadioGroup group, int checkedId) {
//                if (checkedId == R.id.rbtnApprove) {
//                    holder.cbPresentOnLeave.setVisibility(View.VISIBLE);
//                } else {
//                    holder.cbPresentOnLeave.setVisibility(View.GONE);
//                }
//            }
//        });
//
//
//        holder.tvBtnSave.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                if (!CommonUtil.checkIsEmptyOrNullCommon(holder.tiedtRemarks.getText().toString().trim())) {
//                    String comments = holder.tiedtRemarks.getText().toString().trim();
//                    String slId = hodStudentLeaveApproveApplicationAllPojo.getSlId() + "";
//                    String chIsPresentOrNot = "";
//                    String approveRejectStatus = LEAVE_APPROVAL_STATUS_REJECT;
//                    if (holder.rgroupApproveReject.getCheckedRadioButtonId() == R.id.rbtnApprove) {
//                        approveRejectStatus = LEAVE_APPROVAL_STATUS_APPROVE;
//                        chIsPresentOrNot = holder.cbPresentOnLeave.isChecked() ? "1" : "0";
//                    }
//                    submitRemarksApiCall(slId, comments, chIsPresentOrNot, approveRejectStatus);
//                } else {
...
//
//        TextViewRegularFont tvStudentName;
//        TextViewRegularFont tvCourse;
//        TextViewRegularFont tvSem;
//        TextViewRegularFont tvDiv;
//        TextViewRegularFont tvDate;
//        TextViewRegularFont tvLectureNo;
//        TextViewRegularFont tvStatus;
//        TextViewRegularFont tvRemarks;
//        AppCompatImageView imgViewDoc;
//        RadioGroup rgroupApproveReject;
//        TextInputEditText tiedtRemarks;
//        TextViewRegularFont tvBtnSave;
//        MaterialCheckBox cbPresentOnLeave;
//
//        public MyViewHolder(@NonNull View itemView) {
//            super(itemView);
...
//
//            cbPresentOnLeave = itemView.findViewById(R.id.cbPresentOnLeave);
//            tvStatus = itemView.findViewById(R.id.tvStatus);
//            tvStudentName = itemView.findViewById(R.id.tvStudentName);
//            tvCourse = itemView.findViewById(R.id.tvCourse);
//            tvSem = itemView.findViewById(R.id.tvSem);
//            tvDiv = itemView.findViewById(R.id.tvDiv);
//            tvDate = itemView.findViewById(R.id.tvDate);
//            tvLectureNo = itemView.findViewById(R.id.tvLectureNo);
//            tvRemarks = itemView.findViewById(R.id.tvRemarks);
//            imgViewDoc = itemView.findViewById(R.id.imgViewDoc);
//            rgroupApproveReject = itemView.findViewById(R.id.rgroupApproveReject);
//            tiedtRemarks = itemView.findViewById(R.id.tiedtRemarks);
//            tvBtnSave = itemView.findViewById(R.id.tvBtnSave);
//        }
//    }
//
...
//        DialogUtil.showProgressDialogNotCancelable(context, "");
//        ApiImplementer.updateStudentLeaveApprovalStatusApiImplementer(slId, mySharedPreferences.getEmpId(), mySharedPreferences.getEmpInstituteId(),
//                mySharedPreferences.getEmpYearId(), comments, "0", approveRejectStatus, chkPresentOrNot, new Callback<HODAndCoOrdinatorApprovLeavePojo>() {
//                    @Override
//                    public void onResponse(Call<HODAndCoOrdinatorApprovLeavePojo> call, Response<HODAndCoOrdinatorApprovLeavePojo> response) {
//                        DialogUtil.hideProgressDialog();
//                        try {
