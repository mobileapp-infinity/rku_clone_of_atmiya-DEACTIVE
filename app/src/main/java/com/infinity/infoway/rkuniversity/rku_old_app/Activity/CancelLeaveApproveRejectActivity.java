...
//                DialogUtils.hideProgressDialog();
    ...
    private void RejectCancelLeave(String reason, AlertDialog show)
    {
        ...
        String url = URLS.employee_cancel_leave_application_reject + "&id=" + ID + "&user_id=" + mySharedPreferecesRKUOLD.getUserID() + "&ip=" + "1" + "&reason=" + reason + "";
        url = url.replace(" ", "%20");
    ...
    private void RejectCancelLeaveMailSend()
    {
        ...
        StringRequest request = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                System.out.println("success response employee_cancel_leave_application_reject_mail !!!!!!!!!!!!!!!!!!!" + response + "");
...
//                            DialogUtils.Show_Toast(CancelLeaveApproveRejectActivity.this, addMissPunchPojo.getData().get(0).getMsg());
    ...
    private void ApproveCancelLeave() {
        ...
        DialogUtils.showProgressDialog(CancelLeaveApproveRejectActivity.this, "");
        String url = URLS.employee_cancel_leave_application_approve + "&id=" + ID + "&user_id=" + mySharedPreferecesRKUOLD.getUserID() + "&ip=" + "1" + "";
