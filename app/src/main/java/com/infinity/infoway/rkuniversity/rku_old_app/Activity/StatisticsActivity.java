...
import com.infinity.infoway.rkuniversity.rku_old_app.Adapter.StatisticsAdapter;
import com.infinity.infoway.rkuniversity.rku_old_app.CommonCls.CustomBoldTextView;
import com.infinity.infoway.rkuniversity.rku_old_app.CommonCls.DialogUtils;
import com.infinity.infoway.rkuniversity.rku_old_app.CommonCls.MySharedPreferecesRKUOLD;
import com.infinity.infoway.rkuniversity.rku_old_app.CommonCls.URLS;
import com.infinity.infoway.rkuniversity.rku_old_app.Pojo.StatisticsPojo;
...
public class StatisticsActivity extends AppCompatActivity implements View.OnClickListener
{
    ...
    private void StatisticsDisplay()
    {
        ...
        String url = URLS.Get_Other_Statistics + "&user_id=" + mySharedPreferecesRKUOLD.getUserID() + "";
        url = url.replace(" ","%20");
...
//                DialogUtils.hideProgressDialog();
                if (response.length()>10)
                {
                    ...
                    System.out.println("success response Get_Other_Statistics !!!!!!!!!!!!!!!!!!!" + response + "");
