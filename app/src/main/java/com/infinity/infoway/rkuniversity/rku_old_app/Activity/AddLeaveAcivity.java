...
import com.infinity.infoway.rkuniversity.rku_old_app.Pojo.CancelLeaveMailPojo;
import com.infinity.infoway.rkuniversity.rku_old_app.Pojo.EmpLeaveBalancePojo;
import com.infinity.infoway.rkuniversity.rku_old_app.Pojo.InOutTimePojo;
import com.infinity.infoway.rkuniversity.rku_old_app.Pojo.LeaveDaysPojo;
import com.infinity.infoway.rkuniversity.rku_old_app.Pojo.LeaveDetailPojo;
import com.infinity.infoway.rkuniversity.rku_old_app.Pojo.LeaveTypePojo;
import com.infinity.infoway.rkuniversity.rku_old_app.Pojo.NotesPojo;
import com.infinity.infoway.rkuniversity.rku_old_app.Pojo.ReasonPojo;
...
//        DialogUtils.showProgressDialog(AddLeaveAcivity.this, "");
        String url = URLS.Get_employee_inout_time + "&emp_id=" + mySharedPreferecesRKUOLD.getEmpID() + "";
        url = url.replace(" ", "%20");
...
//                DialogUtils.hideProgressDialog();
    ...
    private void CalculateLeaveDays() {
        DialogUtils.showProgressDialog(AddLeaveAcivity.this, "");
        String url = URLS.Get_Employee_Leave_Days + "&from_date=" + edtfromdate.getText().toString() + "&to_date=" + edttodate.getText().toString() + "&empid=" + mySharedPreferecesRKUOLD.getEmpID() + "";
        url = url.replace(" ", "%20");
...
/*
    ...
    private void AddLeave()
    {
        ...
        String url1 = URLS.Employee_leave_application_insert + "&leave_id=" + leave_IDD + "&emp_id=" + mySharedPreferecesRKUOLD.getEmpID() + "&leave_type=" + leave_ID + "&from_date=" + IN_date_time+ "&to_date=" + Out_date_time + "&remark=" + edtremark.getText().toString().trim() + "&reason=" + Reason_ID + "&load_adjusted=" + load_adjust_ID + "&address_while_on_leave=" + edtadd.getText().toString().trim() + "&contact_no=" + edtconno.getText().toString().trim() + "&leave_days=" + edtday.getText().toString().trim() + "&emergency_leave=" + is_emergency + "&user_id=" + mySharedPreferecesRKUOLD.getUserID() + "&ip_address=" + "1" + "&leave_balance=" + edtleavebalance.getText().toString().trim() + "";
...
//                            edtleavebalance.setText(empLeaveBalancePojo.getData().get(0).getBalance() + "");
    ...
    private void CalculateLeaveBalance()
    {
        ...
        DialogUtils.showProgressDialog(AddLeaveAcivity.this, "");
        String url = URLS.Get_Employee_Leave_balance + "&emp_id=" + mySharedPreferecesRKUOLD.getEmpID() + "&leave_type=" + leave_ID + "";
        url = url.replace(" ", "%20");
...
//                 System.out.println("sucess response Get_miss_punch_detail !!!!!!!!!!!!!!!!!!!" + response + "");
    ...
    private void ApplyCancelLeave(String reason, AlertDialog show) {
        DialogUtils.showProgressDialog(AddLeaveAcivity.this, "");
        String url = URLS.Apply_Cancel_Leave_application + "&id=" + ID + "&user_id=" + mySharedPreferecesRKUOLD.getUserID() + "&ip=" + "1" + "&reason=" + reason + "";
        url = url.replace(" ", "%20");
    ...
    private void ApplyCancelLeaveMailSend() {
        ...
        StringRequest request = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                System.out.println("success response Apply_Cancel_Leave_application_mail !!!!!!!!!!!!!!!!!!!" + response + "");
...
//                    AddMissPunchPojo addMissPunchPojo = gson.fromJson(response, AddMissPunchPojo.class);
    ...
    {
        DialogUtils.showProgressDialog(AddLeaveAcivity.this, "");
        String url = URLS.employee_leave_application_mst_delete + "&id=" + ID + "&user_id=" + mySharedPreferecesRKUOLD.getUserID() + "&ip=" + "1" + "";
        url = url.replace(" ","%20");
