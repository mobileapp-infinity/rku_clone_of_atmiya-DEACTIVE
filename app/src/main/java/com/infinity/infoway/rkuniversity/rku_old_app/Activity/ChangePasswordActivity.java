...
import com.infinity.infoway.rkuniversity.rku_old_app.Pojo.ChangepswPojo;
...
//        String url = URLS.LoginCheck + "&userName=" + edtuname.getText().toString() + "&passWord=" + edtpassword.getText().toString() + "";
        String url = URLS.Employee_Change_password + "&user_id=" + mySharedPreferecesRKUOLD.getUserID() + "&ip=" + "1" + "&oldPassword=" + old_psw + "&newPassword=" + new_psw + "";
        ...
        StringRequest request = new StringRequest(Request.Method.GET, url, new Response.Listener<String>()
        {
            ...
            public void onResponse(String response)
            {
                ...
                if (response.length() > 5)
                {
                    ...
                    System.out.println("success response Employee_Change_password !!!!!!!!!!!!!!!!!!!" + response + "");
                    Gson gson = new Gson();
