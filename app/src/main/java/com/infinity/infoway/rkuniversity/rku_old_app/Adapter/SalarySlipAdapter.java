...
import com.infinity.infoway.rkuniversity.rku_old_app.Pojo.SalaryDwnloadPojo;
import com.infinity.infoway.rkuniversity.rku_old_app.Pojo.SalarySlipPojo;
...
public class SalarySlipAdapter extends BaseAdapter {
    ...
    public SalarySlipAdapter(Context ctx, SalarySlipPojo salarySlipPojo,Activity activity) {
        ...
        mySharedPreferenses = new MySharedPreferecesRKUOLD(ctx);
