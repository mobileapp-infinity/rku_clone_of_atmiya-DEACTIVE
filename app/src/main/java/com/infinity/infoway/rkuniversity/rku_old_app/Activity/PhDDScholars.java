...
import com.infinity.infoway.rkuniversity.rku_old_app.Adapter.Phd_scolars_awardedAdapter;
...
//                ApprovleaveListingAPICall(PAGE_NUMBER, isChecked);
    ...
    public static void Phddscholarsapprovelist(final int page_no, boolean isc)
    {
        ...
        if (isc)
        {
            url = URLS.Get_PhD_Scholars_Guided_list + "&user_id=" + mySharedPreferecesRKUOLD.getUserID() + "&emp_id=" + mySharedPreferecesRKUOLD.getEmpID() + "&RowsPerPage=" + URLS.RowsPerPage + "&PageNumber=" + page_no + "&status=" + "2" + "&id=" + "0" + "";
        } else {

            url = URLS.Get_PhD_Scholars_Guided_list + "&user_id=" + mySharedPreferecesRKUOLD.getUserID() + "&emp_id=" + mySharedPreferecesRKUOLD.getEmpID() + "&RowsPerPage=" + URLS.RowsPerPage + "&PageNumber=" + page_no + "&status=" + "1" + "&id=" + "0" + "";
        }
        url = url.replace(" ", "%20");
