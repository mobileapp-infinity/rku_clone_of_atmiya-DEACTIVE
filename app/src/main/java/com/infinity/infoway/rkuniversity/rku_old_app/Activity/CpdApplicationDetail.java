...
import com.infinity.infoway.rkuniversity.rku_old_app.Pojo.CPDAppPojo;
...
//        if (status.compareToIgnoreCase("Pending")==0)
        ...
        String url = URLS.Get_CPD_Application_list + "&user_id=" + mySharedPreferecesRKUOLD.getUserID() + "&emp_id=" + mySharedPreferecesRKUOLD.getEmpID() + "&RowsPerPage=" + URLS.RowsPerPage + "&PageNumber=" + "1" + "&status=" + status + "&id=" + id + "";
                                    ...
                                    ivfile.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View v) {
                                            ...
                                            if (!marshMallowPermission.checkPermissionForExternalStorage()) {
                                                ...
                                                if (cpdAppPojo.getData().get(0).getCPD_Application_Form_Download() != null &&
                                                        !cpdAppPojo.getData().get(0).getCPD_Application_Form_Download().isEmpty()) {
                                    ...
                                    ivfilereport.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View v) {
                                            ...
                                            if (!marshMallowPermission.checkPermissionForExternalStorage()) {
                                                ...
                                                if (cpdAppPojo.getData().get(0).getConducation_Report_Download() != null &&
                                                        !cpdAppPojo.getData().get(0).getConducation_Report_Download().isEmpty()) {
                                                    lldocreport.setVisibility(View.VISIBLE);
                                                    ...
                                                    lldocreport.setVisibility(View.GONE);
                                                    Toast.makeText(activity, "No Data Found!", Toast.LENGTH_SHORT).show();
                                                }
                                            }
    ...
    private class DownloadFileFromURL extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... f_url) {
            ...
            try {
                ...
                conection.connect();
//                File dir = new File(Environment.getExternalStorageDirectory().getAbsolutePath() + "/Rku/" + "/CpdApp/");
//                dir.mkdirs();
//
//
...
//                // this will be useful so that you can show a tipical 0-100% progress bar
                ...
                File folder = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS) + "/" + FileAndFolderInfo.FOLDER_NAME + "/CPDApproval/");
                folder.mkdirs();

                String actualFileName = FileAndFolderInfo.getCustomeFileName(mySharedPreferecesRKUOLD.getEmpCode(), "CPDApproval",
...
//                OutputStream output = new FileOutputStream("sdcard/Rku/" + "/CpdApp/" + nameoffile);
...
//
//            File file11 = new File(Environment.getExternalStorageDirectory().getAbsolutePath(), "Rku/" + "/CpdApp/" + nameoffile);
...
////
            ...
            File file11 = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "/" + FileAndFolderInfo.FOLDER_NAME + "/CPDApproval/" + actualFileName);
...
//                Uri uri = FileProvider.getUriForFile(_context, _context.getPackageName() , file11);
    ...
    private void initView() {
        ...
        tvapprove.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showDialog(CpdApplicationDetail.this, IntentConstants.APPROVED_STATUS_FOR_APPROVAL, ID);
            ...
            public void onClick(View v) {
                DialogUtils.showDialog4YNo(CpdApplicationDetail.this, "", "Are You Sure To Reject ?", new DialogUtils.DailogCallBackOkButtonClick() {
                    ...
                    public void onDialogOkButtonClicked() {
                        showDialog(CpdApplicationDetail.this, IntentConstants.REJECT_STATUS_FOR_APPROVAL, ID);
...
//        if (app_rej.compareToIgnoreCase("approve")==0)
        if (app_rej.compareToIgnoreCase(IntentConstants.APPROVED_STATUS_FOR_APPROVAL) == 0) {
            url = URLS.Get_CPD_Application_Approved_or_Reject + "&id=" + ID + "&remarks=" + reason + "&user_id=" + mySharedPreferecesRKUOLD.getUserID() + "&ip=" + "" + "&approve_reject=" + "1" + "";

        } else {
            url = URLS.Get_CPD_Application_Approved_or_Reject + "&id=" + ID + "&remarks=" + reason + "&user_id=" + mySharedPreferecesRKUOLD.getUserID() + "&ip=" + "" + "&approve_reject=" + "2" + "";
