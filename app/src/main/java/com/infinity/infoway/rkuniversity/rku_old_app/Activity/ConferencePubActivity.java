...
import com.infinity.infoway.rkuniversity.rku_old_app.Adapter.ConfarancePubAdapter;
...
public class ConferencePubActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_conference_pub);
...
//                ApprovleaveListingAPICall(PAGE_NUMBER, isChecked);
    ...
    public static void ApproveConfarancePub(final int page_no, final Boolean Isc)
    {
        ...
        if (Isc)
        {
            ...
            url = URLS.Get_publication_conference_list + "&user_id=" + mySharedPreferecesRKUOLD.getUserID() + "&emp_id=" + mySharedPreferecesRKUOLD.getEmpID() + "&RowsPerPage=" + URLS.RowsPerPage + "&PageNumber=" + page_no + "&status=" + "2" + "&id="+"0"+"";
        }
        else
            {

            // url = URLS.Get_leave_approve_list + "&user_id=" + "1" + "&RowsPerPage=" + URLS.RowsPerPage + "&PageNumber=" + PageNo + "&status=" + "1" + "";
            url = URLS.Get_publication_conference_list + "&user_id=" + mySharedPreferecesRKUOLD.getUserID() + "&emp_id=" + mySharedPreferecesRKUOLD.getEmpID() + "&RowsPerPage=" + URLS.RowsPerPage + "&PageNumber=" + page_no + "&status=" + "1" + "&id="+"0"+"";
        }
        url = url.replace(" ", "%20");
