...
public class ApprovePdWindowPojo
{
    ...
    public static class DataBean {
        /**
         * pdar_remarks : Department will recognized at other institute and build up the good reputation.
         * pdar_credit : 12
         * pdar_duty_leaves : 2
         * approve_by : BHARAT NANJIBHAI ASODARIYA
         * is_visible : 1
         * pd_event_credit : 12
         * pd_no_od_leaves : 2
         * pd_final_leave_from_date : 02/01/2020
         * pd_final_to_date : 03/01/2020
         * pd_final_registration_fees : 0
         * pd_final_transportation : 0
         * pd_final_accommodation : 0
         * pd_final_leave_expense : 4000
         * pd_final_total_expense : 4000
         * pd_sanction_expense : 0
         * budget : 7000
         */
