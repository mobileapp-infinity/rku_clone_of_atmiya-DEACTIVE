...
import com.infinity.infoway.rkuniversity.rku_old_app.Adapter.JournalPublicationadapter;
...
public class JournalPub extends AppCompatActivity {
    ...
    public static void JournalPublicationListing(final int page_no, Boolean isc)
    {
        ...
        if (isc)
        {
            url = URLS.Get_publication_in_journal_list + "&user_id=" + mySharedPreferecesRKUOLD.getUserID() + "&emp_id=" + mySharedPreferecesRKUOLD.getEmpID() + "&RowsPerPage=" + URLS.RowsPerPage + "&PageNumber=" + page_no + "&status=" + "2" + "&id=" + "0" + "";
        } else {

            url = URLS.Get_publication_in_journal_list + "&user_id=" + mySharedPreferecesRKUOLD.getUserID() + "&emp_id=" + mySharedPreferecesRKUOLD.getEmpID() + "&RowsPerPage=" + URLS.RowsPerPage + "&PageNumber=" + page_no + "&status=" + "1" + "&id=" + "0" + "";
        }
        url = url.replace(" ", "%20");
