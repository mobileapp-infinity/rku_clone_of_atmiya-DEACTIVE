...
public class FacultyEventListAdapter extends RecyclerView.Adapter<FacultyEventListAdapter.MyViewHolder>{

    private Context context;
    private ArrayList<EventModel.Array> eventDetailsArrayList;
    private LayoutInflater layoutInflater;

    public FacultyEventListAdapter(Context context, ArrayList<EventModel.Array> eventDetailsArrayList) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = layoutInflater.inflate(R.layout.faculty_event_list_item, parent, false);
