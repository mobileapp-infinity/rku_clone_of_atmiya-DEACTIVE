...
public class MarshMallowPermission
{
    ...
    public static final int REQUEST_CODE_FOR_READ_EXTERNAL_STORAGE_PERMISSION = 5;
    Context _context;
    Activity activity;
    ...
    public void requestPermissionForReadExternalStorage()
    {
        ...
        {
            ActivityCompat.requestPermissions(activity, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, REQUEST_CODE_FOR_READ_EXTERNAL_STORAGE_PERMISSION);
        }
    }
