...
public class CoOrdinatorViewAllLeaveAdapter extends RecyclerView.Adapter<CoOrdinatorViewAllLeaveAdapter.MyViewHolder>{

    private Context context;
    private ArrayList<CoOrdinatorLeaveListPojo> coOrdinatorLeaveListPojos;
    private LayoutInflater layoutInflater;
    private MySharedPreferences mySharedPreferences;
    private CoOrdinatorPendingLeaveAdapter.IApproveOrRejectLeave iApproveOrRejectLeave;
    ...
    public CoOrdinatorViewAllLeaveAdapter(Context context,
                                          ArrayList<CoOrdinatorLeaveListPojo> coOrdinatorLeaveListPojos, CoOrdinatorPendingLeaveAdapter.IApproveOrRejectLeave iApproveOrRejectLeave) {
        this.context = context;
        this.coOrdinatorLeaveListPojos = coOrdinatorLeaveListPojos;
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = layoutInflater.inflate(R.layout.co_ordinator_view_all_leave_list_item, parent, false);
        return new MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        CoOrdinatorLeaveListPojo coOrdinatorLeaveListPojo = coOrdinatorLeaveListPojos.get(position);

        if (!CommonUtil.checkIsEmptyOrNullCommon(coOrdinatorLeaveListPojo.getStudNameApp())) {
            holder.tvStudentName.setText(coOrdinatorLeaveListPojo.getStudNameApp() + "");
        }

        if (!CommonUtil.checkIsEmptyOrNullCommon(coOrdinatorLeaveListPojo.getLeaveDate())) {
            holder.tvLeaveDate.setText(coOrdinatorLeaveListPojo.getLeaveDate() + "");
        }

        if (!CommonUtil.checkIsEmptyOrNullCommon(coOrdinatorLeaveListPojo.getStudRemarks())) {
            holder.tvLeaveRemaks.setText(coOrdinatorLeaveListPojo.getStudRemarks() + "");
        }

        if (!CommonUtil.checkIsEmptyOrNullCommon(coOrdinatorLeaveListPojo.getAppStatusText())) {
            String leaveStatus = coOrdinatorLeaveListPojo.getAppStatusText() + "";
            holder.tvStatus.setText(coOrdinatorLeaveListPojo.getAppStatusText() + "");

            String approveRejectStatus = coOrdinatorLeaveListPojo.getAppStatus()+ "";//0 Pending,1 Approved,2Reject
        ...
        if (!CommonUtil.checkIsEmptyOrNullCommon(coOrdinatorLeaveListPojo.getViewFile()) &&
                coOrdinatorLeaveListPojo.getViewFile().length() > 7) {
        ...
        holder.tvClikToView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String fileUrl = coOrdinatorLeaveListPojo.getViewFile().trim();
        ...
        holder.btnApprove.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showHodLeaveDialog(coOrdinatorLeaveListPojo, true);
            }
        });
        ...
        holder.btnReject.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showHodLeaveDialog(coOrdinatorLeaveListPojo, false);
            }
        });
    }
    ...
    public int getItemCount() {
        return coOrdinatorLeaveListPojos.size();
    }
    ...
    private void showHodLeaveDialog(CoOrdinatorLeaveListPojo coOrdinatorLeaveListPojo, boolean isApprove) {
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String slId = coOrdinatorLeaveListPojo.getSlId() + "";
