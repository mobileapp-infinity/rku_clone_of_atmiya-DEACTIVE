...
import com.infinity.infoway.rkuniversity.rku_old_app.Adapter.BookChapterAdpater;
...
//                ApprovleaveListingAPICall(PAGE_NUMBER, isChecked);
    ...
    public static  void BookChapterApproveList(final int page_no , final boolean isc)
    {
        ...
        if (isc)
        {
            url = URLS.Get_Book_Chapter_Publication_list + "&user_id=" + mySharedPreferecesRKUOLD.getUserID() + "&emp_id=" + mySharedPreferecesRKUOLD.getEmpID() + "&RowsPerPage=" + URLS.RowsPerPage + "&PageNumber=" + page_no + "&status=" + "2" + "&id=" + "0" + "";
        } else {

            url = URLS.Get_Book_Chapter_Publication_list + "&user_id=" + mySharedPreferecesRKUOLD.getUserID() + "&emp_id=" + mySharedPreferecesRKUOLD.getEmpID() + "&RowsPerPage=" + URLS.RowsPerPage + "&PageNumber=" + page_no + "&status=" + "1" + "&id=" + "0" + "";
        }
        url = url.replace(" ", "%20");
