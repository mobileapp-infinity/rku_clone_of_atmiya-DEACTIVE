...
public class TestPojo {
    ...
    public static class DataBean {
         ...
         * pd_event_credit : 5
         * pd_no_od_leaves : 8
         * pd_final_leave_from_date : 18/12/2019
         * pd_final_to_date : 31/12/2019
         * pd_final_registration_fees : 5
         * pd_final_transportation : 8
         * pd_final_accommodation : 8
         * pd_final_leave_expense : 8
         * pd_final_total_expense : 29
         * pd_sanction_expense : 21
         * budget : 5000
         */
