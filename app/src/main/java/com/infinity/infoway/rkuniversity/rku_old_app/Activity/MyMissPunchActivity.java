...
import com.infinity.infoway.rkuniversity.rku_old_app.Adapter.MyMissPunchAdapter;
import com.infinity.infoway.rkuniversity.rku_old_app.CommonCls.CustomBoldTextView;
import com.infinity.infoway.rkuniversity.rku_old_app.CommonCls.DialogUtils;
import com.infinity.infoway.rkuniversity.rku_old_app.CommonCls.MySharedPreferecesRKUOLD;
import com.infinity.infoway.rkuniversity.rku_old_app.CommonCls.URLS;
import com.infinity.infoway.rkuniversity.rku_old_app.Pojo.MissPunchListPojo;
...
public class MyMissPunchActivity extends AppCompatActivity
{
    ...
    {
        String url = URLS.Get_miss_punch_request_list + "&emp_id=" + mySharedPreferecesRKUOLD.getEmpID() + "&RowsPerPage=" + URLS.RowsPerPage + "&PageNumber=" + PageNo + "";
        url = url.replace(" ","%20");
...
//                DialogUtils.hideProgressDialog();
                ...
                if (response.length() > 5)
                {
                    ...
                    System.out.println("success response Get_miss_punch_request_list !!!!!!!!!!!!!!!!!!!" + response + "");
                    Gson gson = new Gson();
