...
import com.infinity.infoway.rkuniversity.rku_old_app.Adapter.PDAppDocumentApprovalAdapter;
...
public class PDAppDocumentApprovalListing extends AppCompatActivity {
    ...
    public static ListView lv_pd_doc_approve;
...
//            pdAppDocumentApprovalAdapter = null;
        ...
        if (PDAppDocumentApprovalActivity.is_back) {
            PDAppDocumentApprovalActivity.is_back = false;
    ...
    public static List<PdApprovalListingPojo.DataBean> listall = new ArrayList<>();

    public static void PDAppDocumentApprovalListingAPI(final int page_no, final boolean isChecked) {
        ...
        if (isChecked) {
            ...
            url = URLS.Get_pd_document_approval_list + "&user_id=" + mySharedPreferecesRKUOLD.getUserID() + "&emp_id=" + mySharedPreferecesRKUOLD.getEmpID() + "&RowsPerPage=" + URLS.RowsPerPage + "&PageNumber=" + page_no + "&status=" + "2" + "";
        } else {
            ...
            url = URLS.Get_pd_document_approval_list + "&user_id=" + mySharedPreferecesRKUOLD.getUserID() + "&emp_id=" + mySharedPreferecesRKUOLD.getEmpID() + "&RowsPerPage=" + URLS.RowsPerPage + "&PageNumber=" + page_no + "&status=" + "1" + "";
        }
        url = url.replace(" ", "%20");
