...
public class CoOrdinatorPendingLeaveAdapter extends RecyclerView.Adapter<CoOrdinatorPendingLeaveAdapter.MyViewHolder>{
    ...
    public CoOrdinatorPendingLeaveAdapter(Context context,
                                          ArrayList<CoOrdinatorLeaveListPojo> coOrdinatorLeaveListPojos, IApproveOrRejectLeave iApproveOrRejectLeave) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = layoutInflater.inflate(R.layout.co_ordinator_pending_leave_list_item, parent, false);
